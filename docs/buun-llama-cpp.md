> This is the README of the upstream fork [buun-llama-cpp](https://github.com/spiritbuun/buun-llama-cpp), kept for reference.
> kt-llama.cpp inherits its VBR / TurboQuant KV cache, TCQ codecs and speculative decoding. See the [main README](../README.md) for this fork.
...
- Run with Docker - see our [Docker documentation](docker.md)
- Download pre-built binaries from the [releases page](https://github.com/ggml-org/llama.cpp/releases)
- Build from source by cloning this repository - check out [our build guide](build.md)
...
| --- | --- |
| [BLAS](build.md#blas-build) | All |
| [BLIS](backend/BLIS.md) | All |
| [CANN](build.md#cann) | Ascend NPU |
| [CUDA](build.md#cuda) | Nvidia GPU |
| [HIP](build.md#hip) | AMD GPU |
| [Hexagon](backend/snapdragon/README.md) | Snapdragon |
| [IBM zDNN](backend/zDNN.md) | IBM Z & LinuxONE |
| [MUSA](build.md#musa) | Moore Threads GPU |
| [Metal](build.md#metal-build) | Apple Silicon |
| [OpenCL](backend/OPENCL.md) | Adreno GPU |
| [OpenVINO [In Progress]](backend/OPENVINO.md) | Intel CPUs, GPUs, and NPUs |
| [RPC](https://github.com/ggml-org/llama.cpp/tree/master/tools/rpc) | All |
| [SYCL](backend/SYCL.md) | Intel GPU |
| [VirtGPU](backend/VirtGPU.md) | VirtGPU APIR |
| [Vulkan](build.md#vulkan) | GPU |
| [WebGPU](build.md#webgpu) | All |
| [ZenDNN](build.md#zendnn) | AMD CPU |
...
- [Build on Android](android.md)
- [Multi-GPU usage](multi-gpu.md)
- [Performance troubleshooting](development/token_generation_performance_tips.md)
- [GGML tips & tricks](https://github.com/ggml-org/llama.cpp/wiki/GGML-Tips-&-Tricks)
- [XCFramework](xcframework.md)
