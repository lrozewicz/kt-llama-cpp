...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_DFLASH2_CONV_KERNEL_SIZE, "%s.conv_kernel_size"        },
    { LLM_KV_DFLASH2_CONV_GROUP_SIZE,  "%s.conv_group_size"         },
    { LLM_KV_DFLASH2_SELECTOR_RANK,     "%s.selector_rank"           },
    { LLM_KV_DFLASH2_SELECTOR_TOP_K,    "%s.selector_top_k"          },
    ...
    { LLM_KV_DFLASH_COMPAT_BLOCK_SIZE, "%s.block_size"      },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_DFLASH2_SELECTOR_HIDDEN,                 "selector.hidden_proj" },
    { LLM_TENSOR_DFLASH2_SELECTOR_PRED,                   "selector.pred_codebook" },
    { LLM_TENSOR_DFLASH2_SELECTOR_SUCC,                   "selector.succ_codebook" },
    { LLM_TENSOR_DFLASH2_ATTN_CONV_BASE,                  "blk.%d.attn_conv.base" },
    { LLM_TENSOR_DFLASH2_ATTN_CONV_PROJ,                  "blk.%d.attn_conv.proj" },
    { LLM_TENSOR_DFLASH2_FFN_CONV_BASE,                   "blk.%d.ffn_conv.base" },
    { LLM_TENSOR_DFLASH2_FFN_CONV_PROJ,                   "blk.%d.ffn_conv.proj" },
...
// latent projections feed ggml_mul_mat, the buft probe must use MUL_MAT to keep them on GPU
    ...
    {LLM_TENSOR_DFLASH2_SELECTOR_HIDDEN,     {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DFLASH2_SELECTOR_PRED,       {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_GET_ROWS}},
    {LLM_TENSOR_DFLASH2_SELECTOR_SUCC,       {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_GET_ROWS}},
    {LLM_TENSOR_DFLASH2_ATTN_CONV_BASE,      {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DFLASH2_ATTN_CONV_PROJ,      {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DFLASH2_FFN_CONV_BASE,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DFLASH2_FFN_CONV_PROJ,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
