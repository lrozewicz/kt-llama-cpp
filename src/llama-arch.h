...
enum llm_arch {
    ...
    LLM_ARCH_GRANITE_SWITCH = 144,
    LLM_ARCH_GRANITE_SWA = 145,
    LLM_ARCH_CHAMELEON = 95,
    LLM_ARCH_WAVTOKENIZER_DEC,
    LLM_ARCH_PLM,
    LLM_ARCH_BAILINGMOE,
    LLM_ARCH_BAILINGMOE2,
    LLM_ARCH_BAILINGMOE3 = 146,
    LLM_ARCH_DOTS1 = 100,
    LLM_ARCH_DOTS3NOTE = 147,
    LLM_ARCH_ARCEE = 101,
    LLM_ARCH_AFMOE,
    LLM_ARCH_LAGUNA,
    LLM_ARCH_ERNIE4_5,
    ...
    LLM_ARCH_DFLASH_DRAFT = 151,
    LLM_ARCH_GEMMA4_DFLASH_DRAFT = 152,
    LLM_ARCH_KIMI_K3 = 148,
    LLM_ARCH_TALKIE = 135,
    LLM_ARCH_MELLUM,
    LLM_ARCH_EAGLE3,
    LLM_ARCH_MINIMAX_M3,
...
enum llm_kv {
    ...
    LLM_KV_ATTN_RES_BLOCK_SIZE = 217,
    LLM_KV_ACTIVATION_SITU_BETA = 218,
    LLM_KV_ACTIVATION_SITU_LINEAR_BETA = 219,
    LLM_KV_FEED_FORWARD_LENGTH = 33,
    ...
    LLM_KV_EXPERT_LATENT_LENGTH = 220,
    LLM_KV_EXPERT_GATING_FUNC = 48,
    ...
    LLM_KV_ADAPTER_COUNT = 221,
    LLM_KV_ADAPTER_TOKEN_IDS_ACTIVATE = 222,
    LLM_KV_ADAPTER_TOKEN_IDS_SUBSTITUTE = 223,
    LLM_KV_ADAPTER_LORA_RANK = 224,
    LLM_KV_ADAPTER_ROUTER_GAIN = 225,
    LLM_KV_TOKEN_SHIFT_COUNT = 70,
    ...
    LLM_KV_ATTENTION_ROPE_PATTERN = 226,

    LLM_KV_ATTENTION_OUTPUT_SCALE = 96,
    ...
    LLM_KV_ATTENTION_KEY_LENGTH_MLA_SWA = 227,
    LLM_KV_ATTENTION_VALUE_LENGTH_MLA_SWA = 228,
    LLM_KV_ATTENTION_KV_LORA_RANK_SWA = 229,
    LLM_KV_ATTENTION_INDEXER_HEAD_COUNT = 104,
    ...
    LLM_KV_HYPER_CONNECTION_LOW_RANK = 230,

    LLM_KV_PLE_LAYERS = 231,
    LLM_KV_PLE_NGRAM_SIZE = 232,
    LLM_KV_PLE_HEADS_PER_NGRAM = 233,
    LLM_KV_PLE_CONV_KERNEL = 234,
    LLM_KV_PLE_LAYER_MULTIPLIERS = 235,
    LLM_KV_PLE_HEAD_OFFSETS = 236,
    LLM_KV_PLE_HEAD_VOCAB_SIZES = 237,
    LLM_KV_PLE_EOS_TOKEN_ID = 238,
    LLM_KV_PLE_IMAGE_TOKEN_ID = 239,

    LLM_KV_HASH_LAYER_COUNT = 119,
    ...
    LLM_KV_KDA_HEAD_DIM,
    LLM_KV_KDA_SAFE_GATE = 240,
    LLM_KV_KDA_GATE_LOWER_BOUND = 241,

    LLM_KV_WKV_HEAD_SIZE = 147,

    LLM_KV_DFLASH_BLOCK_SIZE,
    LLM_KV_DFLASH_MASK_TOKEN_ID,
    LLM_KV_DFLASH_TARGET_LAYER_IDS,
    LLM_KV_DFLASH_N_TARGET_FEATURES,
    LLM_KV_DFLASH2_CONV_KERNEL_SIZE,
    LLM_KV_DFLASH2_CONV_GROUP_SIZE,
    LLM_KV_DFLASH2_SELECTOR_RANK,
    LLM_KV_DFLASH2_SELECTOR_TOP_K,
    ...
    LLM_KV_BLOCK_SIZE,
    LLM_KV_DFLASH_COMPAT_BLOCK_SIZE = 242,
    LLM_KV_DFLASH_CONV_KERNEL_SIZE = 243,
    LLM_KV_DFLASH_CONV_GROUP_SIZE = 244,
    LLM_KV_DFLASH_SELECTOR_RANK = 245,
    LLM_KV_DFLASH_SELECTOR_TOP_K = 246,
    LLM_KV_NORM_BEFORE_RESIDUAL = 203,
...
enum llm_tensor {
    ...
    LLM_TENSOR_HC_HEAD_NORM = 259,   // qwen4exp
    LLM_TENSOR_HC_HEAD_DOWN = 260,   // qwen4exp
    LLM_TENSOR_HC_HEAD_UP = 261,     // qwen4exp
    LLM_TENSOR_HC_ATTN_FN = 147,
    LLM_TENSOR_HC_ATTN_BASE,
    LLM_TENSOR_HC_ATTN_SCALE,
    LLM_TENSOR_HC_FFN_FN,
    LLM_TENSOR_HC_FFN_BASE,
    LLM_TENSOR_HC_FFN_SCALE,
    LLM_TENSOR_HC_ATTN_NORM = 262,   // qwen4exp
    LLM_TENSOR_HC_ATTN_DOWN = 263,   // qwen4exp
    LLM_TENSOR_HC_ATTN_UP = 264,     // qwen4exp
    LLM_TENSOR_HC_ATTN_INJECT = 265, // qwen4exp
    LLM_TENSOR_HC_FFN_NORM = 266,    // qwen4exp
    LLM_TENSOR_HC_FFN_DOWN = 267,    // qwen4exp
    LLM_TENSOR_HC_FFN_UP = 268,      // qwen4exp
    LLM_TENSOR_HC_FFN_INJECT = 269,  // qwen4exp
    LLM_TENSOR_PLE_KEY = 270,        // qwen4exp
    LLM_TENSOR_PLE_VALUE = 271,      // qwen4exp
    LLM_TENSOR_PLE_NORM_KEY = 272,   // qwen4exp
    LLM_TENSOR_PLE_NORM_QUERY = 273, // qwen4exp
    LLM_TENSOR_PLE_NORM_CONV = 274,  // qwen4exp
    LLM_TENSOR_PLE_CONV1D = 275,     // qwen4exp
    LLM_TENSOR_ATTN_COMPRESSOR_WKV = 153,
    ...
    LLM_TENSOR_DFLASH_ATTN_CONV_BASE = 276,
    LLM_TENSOR_DFLASH_ATTN_CONV_PROJ = 277,
    LLM_TENSOR_DFLASH_FFN_CONV_BASE = 278,
    LLM_TENSOR_DFLASH_FFN_CONV_PROJ = 279,
